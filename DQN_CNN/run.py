...
EPSILON_STOP_EPISODE_RATIO = 0.2
MEMORY_SIZE = 10000
DISCOUNT_FACTOR = 0.99
BATCH_SIZE = 64
EPOCHS_PER_TRAIN_STEP = 1
RENDER_EVERY_N_EPISODES = 500
RENDER_DELAY_TRAINING = 0.001
LOG_EVERY_N_EPISODES = 50
REPLAY_START_SIZE_FRACTION = 0.1
...
POOLING_CONFIGS = [True, True, True]
DENSE_LAYER_NEURONS = [512, 256]
DENSE_LAYER_ACTIVATIONS = ['relu', 'relu', 'linear']
    ...
    for episode in tqdm(range(1, EPISODES + 1), unit="episode"):
        ...
        while not done and (MAX_STEPS_PER_EPISODE is None or steps_this_episode < MAX_STEPS_PER_EPISODE):
            ...
            if not next_possible_moves:
                ...
                break
            chosen_action = agent.best_state(next_possible_moves)
            if chosen_action is None:
                done = True
                break
            resulting_board_matrix_for_memory = next_possible_moves[chosen_action]
        ...
        episode_score = env.get_game_score()
